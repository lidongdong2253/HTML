      ...
      ctor: function ctor() {
        window.addEventListener("onorientationchange" in window ? "orientationchange" : "resize", function() {
          if (180 === window.orientation || 0 === window.orientation) {
            console.log("\u7ad6\u5c4f");
            wsft.message.emit(wsft.protocol.adaptiveView, "portrait");
          }
          if (90 === window.orientation || -90 === window.orientation) {
            console.log("\u6a2a\u5c4f");
            wsft.message.emit(wsft.protocol.adaptiveView, "landscape");
          }
        }, false);
      },
  ...
  shareLayer: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      onLoad: function onLoad() {
        ...
        wsft.message.on(wsft.protocol.adaptiveView, this.showShare.bind(this));
      },
      start: function start() {
        this.showShare();
      },
      showShare: function showShare(date) {
        ...
        if ("portrait" == onorientationChange || "portrait" == date) {
          share_1.active = true;
